...
if __name__ == "__main__":
    ...
    for data in test_json:
        ...
        while current_length < max_length:
            ...
            draft_output = draft_model.generate(input_tensor, max_new_tokens=max_tokens).to(dtype=torch.int32).squeeze(0)
            ...
            first_false_position, past_key_values = oracle_verification(
                oracle_model, draft_output, max_tokens, local_rank, iter_count, past_key_values
            )
            break
